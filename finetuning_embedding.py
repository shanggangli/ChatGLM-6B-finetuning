...
def set_args():
    ...
    parser.add_argument('--model_dir', default="../chatglm-6b-int4", type=str, help='')
    ...
    parser.add_argument('--output_dir', default='output_dir_embedding/', type=str, help='')
...
def main():
    ...
    # Unfreeze the embeddings layer to allow training
